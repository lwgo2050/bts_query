...
// 查询条件参数
var query_asset_name="BTS:GDEX.FGC"
...
ws.onopen = function(event) {
    var param1 ={"id":1,"method":"call","params":[0,"lookup_asset_symbols",[[quote_symbol,base_symbol]]]};
...
function loadData(){
    ...
    $('#tb_departments').bootstrapTable('refresh');
    queryResultStr ='<span style="color:#FF0000">'+query_asset_name+"查询成功</span>";
    hideProgress();
}
...
function deal_asset_sysmbol_message(data) {
    ...
    if (data.result[0] === null) {
        ...
        base_id=data.result[1].id;
        base_precision=data.result[1].precision;
